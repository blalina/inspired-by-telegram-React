...
import classes from "../modules_css/Icons.module.css";

const SvgGeneralOptions = ({ children }) => {
    return (
        <svg className={classes.svgColor} xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#000000">{children}</svg>
    );
};

const SvgDropdownMenu = ({ children }) => {
    return (
        <svg className={`${classes.svgColor} ${classes.svgDropdownMenu}`} xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#000000">{children}</svg>
    );
};
...
export function AttachPhotoIcon() {
    return (
        <SvgGeneralOptions>
...
export function SavedMessageIcon() {
    return (
        <SvgDropdownMenu>
...
export function ArchivedChatsIcon() {
    return (
        <SvgDropdownMenu>
